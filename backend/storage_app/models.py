...
class FileGroup(models.Model):
    ...
    group_id = models.CharField(max_length=20, unique=True)  # ✅ Already unique
    note = models.TextField()
    total_files = models.PositiveIntegerField(default=0)
    ai_status = models.CharField(max_length=20, default="COMPLETED")
...
class UploadedFile(models.Model):
    ...
    class Meta:
        ordering = ["created_at"]
        unique_together = ("user", "file_hash")  # ✅ FIXED: Changed to prevent duplicates across groups
